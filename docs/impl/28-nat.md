...
# --- NAT rules ---
# [SNAT 1] NAT for jail network
ipfw -q add 50000 nat 1 ip from 10.0.0.0/24 to any out xmit em0
# [DNAT 2] Forward HTTP to jail
ipfw -q add 50100 nat 2 tcp from any to me 80 in recv em0

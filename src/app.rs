...
pub fn build(state: AppState) -> Router {
    ...
    let api = Router::new()
        ...
        .route("/api/network/interfaces", get(handlers::network::list_interfaces))
        .route("/api/network/interfaces/{name}", get(handlers::network::interface_detail))
        ...
        .route("/api/bhyve/vms/{name}", get(handlers::bhyve::vm_detail))
        ...
        .route("/api/bhyve/switches", get(handlers::bhyve::list_switches))
        .route("/api/bhyve/datastores", get(handlers::bhyve::list_datastores))
